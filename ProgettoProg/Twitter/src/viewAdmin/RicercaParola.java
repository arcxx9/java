...
public RicercaParola (String parolaR) {
    parola = parolaR;
    initialize ();
}
...
private void initialize () {
    ...
    JLabel labelMenu = new JLabel("Ricerca la parola");
    labelMenu.setForeground(new Color(0, 204, 255));
    labelMenu.setBounds(187, 10, 83, 14);
    panelRicerca.getContentPane().add(labelMenu);
    ...
    JTable table = new JTable (D.ricercaParola(parola));
