...
public class SmsMessageSender implements MessageSender
{
		public void sendMessage(String message, String userSend, String userReceive)
		{
			...
			try{
	            ...
	            D.stmt.executeUpdate( "INSERT INTO `dbtwitter`.`messaggi` (`inviato_user`, `ricevuto_user`,`testo`,`tipo`) VALUES ('"+userSend+"','"+userReceive+"','"+message+"','SMS')" );           	
			...
			System.out.println("'"+message+ "'   : Questo messaggio e` stato inviato tramite SMS");
		}
}
